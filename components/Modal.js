      ...
      >
        <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="fixed inset-0 bg-gray bg-opacity-50 transition-opacity" />
          </Transition.Child>
              ...
              <div>
                {selectedFile ? (
                  ...
                  <div
                    ...
                    className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-blue cursor-pointer"
                  >
                    <CameraIcon
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm
                            px-4 py-2 bg-theme-maroon text-base font-medium text-white hover:bg-gray focus:outline-none
                            focus:ring-2 focus:ring-offset-2 focus:ring-theme-maroon sm:text-sm disabled:bg-gray
                            disabled:cursor-not-allowed hover:disabled:bg-black"
                    onClick={uploadPost}
                  >
